-- VulnLab Seed Data
-- VULN: V2.1 - Passwords are MD5 hashed with no salt
...
(1, 'admin', 'admin@vulncorp.com', '0192023a7bbd73250516f069df18b500', 'admin', 'Admin', 'User', 'System administrator for VulnCorp', '555-0100', '123 Admin St, Corporate HQ', '123-45-6789', 'What is your pet''s name?', 'fluffy', 'JBSWY3DPEHPK3PXP', 1, 'vtoken_a1b2c3d4e5f6'),
(2, 'john', 'john@vulncorp.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user', 'John', 'Smith', 'Regular user account <script>alert("xss")</script>', '555-0101', '456 User Ave, Apt 2B', '987-65-4321', 'What is your pet''s name?', 'buddy', NULL, 0, 'vtoken_g7h8i9j0k1l2'),
(3, 'jane', 'jane@vulncorp.com', 'e10adc3949ba59abbe56e057f20f883e', 'user', 'Jane', 'Doe', 'Product reviewer', '555-0102', '789 Test Blvd', '456-78-9012', 'What city were you born in?', 'springfield', NULL, 0, 'vtoken_m3n4o5p6q7r8'),
(4, 'bob', 'bob@vulncorp.com', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'manager', 'Bob', 'Wilson', 'Department manager', '555-0103', '321 Manager Lane', '111-22-3333', 'What is your mother''s maiden name?', 'johnson', NULL, 0, 'vtoken_s9t0u1v2w3x4'),
(5, 'testuser', 'test@vulncorp.com', '0d107d09f5bbe40cade3de5c71e9e9b7', 'user', 'Test', 'Account', 'Test account for QA', '555-0104', '999 Test Street', '000-00-0000', 'What is your pet''s name?', 'max', NULL, 0, 'vtoken_y5z6a7b8c9d0');

-- Products
INSERT OR IGNORE INTO products (id, name, description, price, category, image_url, stock, is_limited) VALUES
(1, 'VulnCorp Laptop Pro', 'High-performance laptop for security professionals', 1299.99, 'Electronics', '/images/laptop.jpg', 50, 0),
(2, 'Secure Router X1', 'Enterprise-grade router (ironically insecure)', 249.99, 'Networking', '/images/router.jpg', 100, 0),
...
(7, 'Hacker Hoodie', 'Limited edition VulnCorp hoodie', 59.99, 'Apparel', '/images/hoodie.jpg', 25, 0),
...
(10, 'Limited Edition Badge', 'VulnCorp conference badge - LAST ONE!', 999.99, 'Collectibles', '/images/badge.jpg', 1, 1),
...
-- Sample orders with plaintext credit cards (VULN: V6.1)
...
-- Reviews (including XSS payloads - VULN: V5.2)
...
-- Secure messages (VULN: V6.2 - DES encrypted with hardcoded key)
INSERT OR IGNORE INTO messages (from_user_id, to_user_id, subject, body, encrypted) VALUES
(1, 2, 'Welcome to VulnCorp', 'Welcome aboard! Your employee ID is EMP-2024-0042. Please keep this confidential.', 0),
